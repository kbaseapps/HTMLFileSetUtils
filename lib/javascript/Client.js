...
function HTMLFileSetUtils(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.upload_html_set = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "HTMLFileSetUtils.upload_html_set",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "HTMLFileSetUtils.status",
